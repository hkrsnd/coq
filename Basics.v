...
(** $Date: 2016-09-12 05:50:12 +0900 (2016年09月12日 (月)) $ *)


(**
▶ 講義・演習に関する質問/要望

・講義スライドが非常にわかりやすくて英語のホームページをほとんど読まずに課題自体はできてしまう。
・intros,rewriteなどの文法の理解が少し時間がかかり、特にrewriteの逆方向を用いる証明方法は
　なかなか分かりにくいと感じた。


▶ 友達に教えてもらったら、その人の名前，他の資料 (web など) を参考にした場合，その情報源(URL など)．
・http://www.cs.cmu.edu/~emc/15414-s14/lecture/lecture_2_17_2014.v
*)